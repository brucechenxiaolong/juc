...
//            cipher.init(cipherMode, key);
    ...
    public static void main(String[] args) throws IOException {
        //获取被加密文件
        File file = new File("D:/offline/file/23FA4A4C7E3D47F5BCF16446B75E8838.JPG");
        //加密到新文件:2.JPG
        File encrypfile = Aes.encryptFile(FileUtils.openInputStream(file),"D:/offline/file/encrypt/2.JPG");
        //解密新文件到3.JPG
        Aes.decryptFile(encrypfile,"D:/offline/file/encrypt/3.JPG");
    }
